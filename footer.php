    ...
    <div class="container">
        <div class="row justify-content-between align-items-start py-5">
            ...
            <div class="col-md-3 col-12 mb-3">
                ...
                <p class="">Drop us line anytime at <a href="mailto:info@icubesteel.com"
                        class=" text-decoration-none">info@icubesteel.com</a></p>
            </div>
            <div class="col-md-2 col-12">
                <h5 class="text-blue fw-bold pb-2 fs-5"> Follow us</h5>
                <ul class="list-unstyled d-flex">
                    <li class="me-3"><a href="https://www.facebook.com/icubesteel" target="_blank"
                            class="text-decoration-none text-dark">
                        <i class="bi bi-facebook fs-3"></i>
                    </a></li>
                    <li class="me-3"><a href="https://www.instagram.com/icubesteel/" target="_blank"
                            class="text-decoration-none text-dark">
                        <i class="bi bi-instagram fs-3"></i>
                        </a></li>
                    <li class="me-3"><a href="https://www.linkedin.com/company/icubesteel/" target="_blank"
                            class="text-decoration-none text-dark">
                        <i class="bi bi-linkedin fs-3"></i>
                    </a></li>
                    <li class="me-3"><a href="https://twitter.com/icubesteel" target="_blank"
                            class="text-decoration-none text-dark">
